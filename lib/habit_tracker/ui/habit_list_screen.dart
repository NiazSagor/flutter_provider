          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Daily Progress: ${habitProvider.completedHabitCount}/${habitProvider.totalHabits} habits completed',
                ...
                LinearProgressIndicator(
                  value: habitProvider.totalHabits > 0
                      ? habitProvider.completedHabitCount /
                ...
                Text(
                  'Completion Percentage: ${habitProvider.progress.toStringAsFixed(1)}%',
                  style: const TextStyle(
                    fontSize: 16,
